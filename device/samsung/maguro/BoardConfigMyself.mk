...
# This variable is set last by yellow, so it can be overridden
...
# yellow, Define kernel config for inline building
TARGET_KERNEL_CONFIG := yellow_tuna_defconfig
TARGET_KERNEL_SOURCE := kernel/samsung/tuna_franco
